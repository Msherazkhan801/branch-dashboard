...
interface AddHeadOfficeExpenseModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (entry: Omit<HeadOfficeExpenseEntry, "id">, id?: string) => void;
  categories: string[];
  initialEntry?: HeadOfficeExpenseEntry | null;
}

export default function AddHeadOfficeExpenseModal({ isOpen, onClose, onSave, categories, initialEntry = null }: AddHeadOfficeExpenseModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md mx-4 p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-gray-800">{initialEntry ? "Edit Head Office Expense" : "Add Head Office Expense"}</h2>
